    ...
    <body>
      ...
      <div class="header">
        <div class="header-left">
          ...
          ${report.reportCategory ? `<div class="report-meta">Category: ${report.reportCategory}</div>` : ""}
          <div class="report-meta">Date: ${reportDate}</div>
          ${userDisplayName ? `<div class="report-meta">Prepared by: ${userDisplayName}</div>` : ""}
      ...
      <div class="footer">
        ...
        <span>Checksum: ${report.reportChecksum ?? "—"}</span>
      </div>
